...
<div class="testemonial">
    <div class="small-container">
        ...
        try{
			...
			String sql ="select * from productsjee";
            ...
            <div class="col-3">
                ...
                <div class="rating">
                    ...
                    <%String username=rs.getString("id_username"); %>
                    <h5 style="color:red">Owner: </h5><h5><%=rs.getString("id_username") %></h5><br>
        			...
        			while(rs2.next()){
        			%>
                    <h4>ContactOn:+216</h4><h5><%=rs2.getString("phonenumber")%></h5>
